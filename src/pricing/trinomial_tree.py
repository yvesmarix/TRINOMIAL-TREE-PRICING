...
class TrinomialTree(Model):
    ...
    def bs_convergence_by_step(
        self, option, bs_price: float, max_n: int = 1000, step: int = 10
    ):
        """
        ...
        for N in N_values:
            ...
            prices.append(self.root.price(option))
    ...
    def bs_convergence_by_strike(self, option, K_values: list):
        """
        ...
        for K in K_values:
            self.option.K = K
            tree_prices.append(self.root.price(option))
            bs_prices.append(
